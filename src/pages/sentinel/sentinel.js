      ...
      <div className="container-box">
        <div>
            <div className="home-design-conta">
              ...
              <div className="content-box-sentinel" id="about-div2-info">
                <Fade top duration={1250}>
                  <Row>
              ...
              <Fade top duration={1250}>
                <div className="sentinel-card-for-mobile">
                  <Carousel
                    autoPlay={false}
                    autoPlaySpeed={1600}
                    ssr
                  ...
                  >
                    <div className='cards-about-team'>
                      <div className="card-about-team-sentinel">
                        <div className="card-body-about-team">
                          <center><img src={machine} className="team-imgs-senti"/></center>
                        </div>
                        <p className="team-text-title">Attendence Tracker</p>
                        <p className="team-text-subtitle">Random text describing</p>
                      </div>
                    </div>
                    <div className='cards-about-team'>
                      <div className="card-about-team-sentinel">
                        <div className="card-body-about-team">
                          <center><img src={steal} className="team-imgs-senti"/></center>
                        </div>
                        <p className="team-text-title">Violation Detection</p>
                        <p className="team-text-subtitle">Random text describing</p>
                      </div>
                    </div>
                    <div className='cards-about-team'>
                      <div className="card-about-team-sentinel">
                        <div className="card-body-about-team">
                          <center><img src={goal} className="team-imgs-senti"/></center>
                        </div>
                        <p className="team-text-title">Efficiency Monitor</p>
                        <p className="team-text-subtitle">Random text describing</p>
                      </div>
                    </div>
                    <div className='cards-about-team'>
                      <div className="card-about-team-sentinel">
                        <div className="card-body-about-team">
                          <center><img src={pc} className="team-imgs-senti"/></center>
                        </div>
                        <p className="team-text-title">High Value Cage Monitor</p>
                        <p className="team-text-subtitle">Random text describing</p>
                      </div>
                    </div>
                  </Carousel>
            ...
            <div className="sc-hm-one-products-senti2">
              <Fade top duration={1250}>
                <p className="txt_products-senti-3">How Sentinal Helps Your Business</p>
                <center>
                <Row>
